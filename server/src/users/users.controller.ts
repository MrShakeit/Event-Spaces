...
class UsersController {
  ...
  async updateUserCityStatus(req: Request, res: Response) {
    try {
      const id = await usersSchema.validateId(req.params.id);
      await usersService.updateUserCityStatus(id, true);
      res.status(204).send();
    } catch (error) {
      const err = error as CustomError;
      log("error", err.message);
  ...
  async removeUserCityStatus(req: Request, res: Response) {
    try {
      const id = await usersSchema.validateId(req.params.id);
      await usersService.updateUserCityStatus(id, false);
      res.status(204).send();
    } catch (error) {
      const err = error as CustomError;
      log("error", err.message);
  ...
  async blockUser(req: Request, res: Response) {
    try {
      ...
      await usersService.updateUserBlockedStatus(id, true, blockReason);
      res.status(204).send();
    } catch (error) {
      const err = error as CustomError;
      log("error", err.message);
  ...
  async unblockUser(req: Request, res: Response) {
    try {
      const id = await usersSchema.validateId(req.params.id);
      await usersService.updateUserBlockedStatus(id, false, null);
      res.status(204).send();
    } catch (error) {
      const err = error as CustomError;
      log("error", err.message);
